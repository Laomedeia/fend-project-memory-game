...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__js_app_js__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__css_app_css__ = __webpack_require__(6);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_animate_css_animate_min_css__ = __webpack_require__(9);
...
function cardClicked() {
  ...
  if (cardClassName.indexOf("card") != -1 && cardClassName.indexOf("open show") == -1) {
    setClickAnimate(cardElement);
    __WEBPACK_IMPORTED_MODULE_0__js_app_js__["a" /* default */].displayCard(cardElement);
    __WEBPACK_IMPORTED_MODULE_0__js_app_js__["a" /* default */].openCardList.push(cardElement);
    if (__WEBPACK_IMPORTED_MODULE_0__js_app_js__["a" /* default */].openCardList.length == 2) {
      //配对计数
      __WEBPACK_IMPORTED_MODULE_0__js_app_js__["a" /* default */].calcMoves(movesEl);
      //星星计数
      __WEBPACK_IMPORTED_MODULE_0__js_app_js__["a" /* default */].calcStars(starEl);
      //比较配对成功与否
      var result = __WEBPACK_IMPORTED_MODULE_0__js_app_js__["a" /* default */].compareTwoCardsIsEqual(__WEBPACK_IMPORTED_MODULE_0__js_app_js__["a" /* default */].openCardList[0], __WEBPACK_IMPORTED_MODULE_0__js_app_js__["a" /* default */].openCardList[1]);
      if (!result) {
        //配对失败隐藏
        __WEBPACK_IMPORTED_MODULE_0__js_app_js__["a" /* default */].disableCardClick(cardEl);
        setTimeout(() => {
          __WEBPACK_IMPORTED_MODULE_0__js_app_js__["a" /* default */].hideCard(__WEBPACK_IMPORTED_MODULE_0__js_app_js__["a" /* default */].openCardList[0]);
          __WEBPACK_IMPORTED_MODULE_0__js_app_js__["a" /* default */].hideCard(__WEBPACK_IMPORTED_MODULE_0__js_app_js__["a" /* default */].openCardList[1]);
          ...
          __WEBPACK_IMPORTED_MODULE_0__js_app_js__["a" /* default */].recoverCardClick(cardEl);
          return;
        }, 1000);
      } else {
        removeTwoAnimateFlipY(__WEBPACK_IMPORTED_MODULE_0__js_app_js__["a" /* default */].openCardList[0], __WEBPACK_IMPORTED_MODULE_0__js_app_js__["a" /* default */].openCardList[1]);
...
module.exports = __webpack_require__.p + "img/geometry2.png";
